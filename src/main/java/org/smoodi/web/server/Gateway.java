 ...
 *
 * <p>1. 클라이언트의 요청을 <i>Smoodi Web</i>에서 사용하는 형태인 {@link org.smoodi.physalus.transfer.Request Request}로 가공하고 {@link Router}에게 전달</p>
 * <p>2. {@link Router}가 넘겨준 {@link org.smoodi.physalus.transfer.Response Response} 응답 객체를 클라이언트가 분석 가능한 표준 형태로 가공</p>
 */
